...
#+begin_src C
   ...
   4. Now can now execute the ~sin_taylor.bin~ file using the ISS; like
      so:
      #+begin_src bash
	riscv-iss % ./iss ./tests/sin_taylor.bin # ./iss is the ISS and the .bin is the input file
      #+end_src
...
** Reverse debugging
   ...
   #+begin_src bash
     ...
     q for quitting
     a8 # << break point added at assembler instruction a8
     added breakpoint: a8
     q # << quit the adding break point state
     r # << run program until PC = a8
     0:00001137
     4:80010113
     8:0a0000ef
     p
     ...
     z # << print the recorded trace until this point
     ...
     u # << go up one assembler instruction
     Record{	PC: 8, index:1, TAG:REG, word: [00000000]}
     p #<< print the state of the machine
     ...
     fs9: 0	fsa: 0	fsb: 0	ft0: 0
     ft1: 0	ft2: 0	ft3: 0	
     r # << run the program again until break point
     4:80010113
     8:0a0000ef
     p # << print the machine state
     x0: 00000000	ra: 0000000c	sp: 00000800	gp: 00000000	x4: 00000000
     t0: 00000000	t1: 00000000	t2: 00000000	s0: 00000000
     x9: 00000000	a0: 00000000	a1: 00000000	a2: 00000000
     a3: 00000000	a4: 00000000	a5: 00000000	a6: 00000000
